// src/lib.rs
/*
 * Core library for GrafanaDashboard
 */
...
#[derive(Debug)]
pub struct GrafanaDashboardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GrafanaDashboardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GrafanaDashboard processing");
    
    let mut processor = GrafanaDashboardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GrafanaDashboardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GrafanaDashboardProcessor::new(false);
